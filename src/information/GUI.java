...
public class GUI {
    ...
    private final Image imgD = new Image("droid.png");
    private final Image imgB = new Image("utbMAP.PNG");
    private final Image imgE = new Image("utpaMAP.PNG");
    ...
    private void UI() {
        ...
        bp.setStyle("-fx-background-image: url(oBG.gif); "
