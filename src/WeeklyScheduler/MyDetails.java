...
public class MyDetails {
    ...
    public CourseDetails[] getMyCourseDetails() {
        CourseDetails[] my = new CourseDetails[6];
        ...
        my[0] = new CourseDetails("CSCI-4335", "Computer Architecture", 
                "Main 1.514", class_0_1_2, "09:25 AM", "10:40 AM");
        my[1] = new CourseDetails("CSCI-3340", "Software Engineering I", 
                "Main 1.514", class_0_1_2, "10:50 AM", "12:05 PM");
        my[2] = new CourseDetails("CSCI-4318", "Cyber Security",  "LHSB 1.402",
                class_0_1_2, "01:40 PM", "2:55 PM");
        my[3] = new CourseDetails("CSCI-3336", "Organization of Program Lang", 
                "SETB 1.506", class_3_4, "10:50 AM", "12:05 AM");
        my[4] = new CourseDetails("CSCI-4310", "Design & Analysis of Algorithm", 
                "Main 1.508", class_3_4, "09:25 AM", "10:40 AM");
        my[5] = new CourseDetails("KINE-1229", "VolleyBall", "Garza Gym", 
